...
export const skillCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Tailwind CSS', icon: SiTailwindcss, level: 60, color: '#38bdf8' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Spring Tool Suite', icon: SiSpring, level: 82, color: '#6db33f' },
      { name: 'VS Code', icon: VscVscode, level: 70, color: '#007acc' },
      { name: 'IntelliJ IDEA', icon: SiIntellijidea, level: 50, color: '#000000' },
    ],
  },
]
